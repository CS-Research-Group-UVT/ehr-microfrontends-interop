...
export async function buildHeartAttackFeatures({ fhirBaseUrl, patientId, accessToken }) {
...
async function onPredictClick() {
    ...
    const { features, missing } = await buildHeartAttackFeatures({ fhirBaseUrl, patientId });
